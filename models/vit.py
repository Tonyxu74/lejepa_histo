"""
ViT that permits variable input size via positional embedding interpolation
taken from DINO implementation: https://github.com/facebookresearch/dino/blob/main/vision_transformer.py
"""
...
class ViTEncoder(nn.Module):
    """ViT model for self-supervised learning, supports multicrops!"""
    ...
    def __init__(self, args):
        ...
        # match hidden dim of vit size, FC layer from PAWS paper
        hidden_dim = self.model.num_features
